        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/albarraktravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-البراك/عروض-تايلاند/عرض-تايلاند-1.jpg', 'عرض تايلاند - بانكوك - بتايا'],
        image_2: ['عروض-شركة-البراك/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض تايلاند - بانكوك - بوكيت'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-البراك/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'عرض ماليزيا - 7 أيام'],
        image_2: ['عروض-شركة-البراك/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'كوالالمبور & بينبانق & لنكاوي & سنغافورة'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-البراك/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'عرض اسطنبول - 7 أيام'],
        image_2: ['عروض-شركة-البراك/عروض-اسطنبول/عرض-اسطنبول-2.jpg', 'عرض اسطنبول - 7 أيام'],
        image_3: ['عروض-شركة-البراك/عروض-اسطنبول/عرض-اسطنبول-3.jpg', 'عرض اسطنبول - 7 أيام'],
    },

    {
        title: 'عروض فيتنام',
        image_1: ['عروض-شركة-البراك/عروض-فيتنام/عرض-فيتنام-1.jpg', 'عرض فيتنام - 8 أيام'],
    },

    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-البراك/عروض-موسكو/عرض-موسكو-1.jpg', 'عرض موسكو - 7 أيام'],
        image_2: ['عروض-شركة-البراك/عروض-موسكو/عرض-موسكو-2.jpg', 'عرض موسكو - 7 أيام'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-البراك/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'عرض بالي - 7 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966534222608?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/albarraktravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة البراك على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة البراك على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة البراك على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة البراك للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة البراك للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة البراك`;
            img.title = `مكتب سياحي - شركة البراك`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966534222608";
